...
if ($_SERVER['REMOTE_ADDR']==='130.60.154.33'){
    $hookSecret = NULL;
}
...
$commands = array(
    "git init",
    "git remote add origin https://github.com/AstroPhysicsUZH/group_homepage.git",
    "git fetch",
